...
const Sidebar: React.FC<SidebarProps> = ({ sections }) => {
    return (
        <div className="fixed right-0 top-0 h-screen w-48 bg-white shadow-lg p-4">
    ...
    return (
        <div className="flex">
            ...
            <div className="mx-32 flex flex-col items-center justify-center">
                ...
                <Card id="abstract" title='Abstract' cardClass='w-1/2'>
                ...
                <Card id="wetlab" title='Wetlab' cardClass='w-1/2'>
                ...
                <Card id="computational" title='Computational' cardClass='w-1/2'>
